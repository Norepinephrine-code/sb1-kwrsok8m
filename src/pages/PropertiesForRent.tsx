...
export const PropertiesForRentPage: React.FC = () => {
  const [filteredProperties, setFilteredProperties] = useState<Property[]>(
    properties.filter((property) => property.status === 'rent')
  );
  ...
  const handleFilterChange = (filters: {
    ...
    let result = properties.filter((property) => property.status === 'rent');
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600 max-w-3xl">
            Discover our selection of rental properties, ranging from cozy
            apartments to spacious family homes, all in prime locations.
          </p>
        </div>
